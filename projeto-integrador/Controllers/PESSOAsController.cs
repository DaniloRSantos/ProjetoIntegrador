...
namespace Projeto_Integrador.Controllers
{
    public class PESSOAsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CPF_PESSOA,NOM_PESSOA,SNO_PESSOA,DNA_PESSOA,DCA_PESSOA,SEX_PESSOA,PAI_PESSOA,CID_PESSOA,BAI_PESSOA,END_PESSOA,NEN_PESSOA,CEP_PESSOA,TEL_PESSOA,TEM_PESSOA,RG_PESSOA,SEN_PESSOA,EMA_PESSOA,FPE_PESSOA")] PESSOA pESSOA)
        {
