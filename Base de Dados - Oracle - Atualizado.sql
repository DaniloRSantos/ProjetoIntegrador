...
CREATE TABLE FICHA_SIGLA(
    ...
    CONSTRAINT FK_FICHA_SIGLA_FICHA FOREIGN KEY (COD_FICHA, CPF_ALUNO) REFERENCES FICHA
);
...
CREATE TABLE TREINAMENTO (
    ...
    CONSTRAINT FK_TREINAMENTO_FICHA_SIGLA FOREIGN KEY (COD_FICHA,CPF_ALUNO) REFERENCES FICHA
);